...
/**
 * Wraps a Swift `(_ id: Double) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_double {
  public typealias bridge = margelo.nitro.nitrotimer.bridge.swift

  private let closure: (_ id: Double) -> Void

  public init(_ closure: @escaping (_ id: Double) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(id: Double) -> Void {
    self.closure(id)
  }
