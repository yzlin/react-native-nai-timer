...
class HybridNaiTimer : HybridNaiTimerSpec() {
    ...
    private val wakeLock: PowerManager.WakeLock =
            powerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "NaiTimer")
    ...
    override fun setTimeout(callback: (id: Double) -> Unit, delay: Double): Double {
        ...
        val runnable = Runnable {
            try {
                ...
                Log.e("NaiTimer", "Callback error in setTimeout($timerId): ${e.message}", e)
            }
                ...
                object : Runnable {
                    override fun run() {
                        try {
                            ...
                            Log.e(
                                    "NaiTimer",
                                    "Callback error in setInterval($timerId): ${e.message}",
                                    e
                            )
                        }
