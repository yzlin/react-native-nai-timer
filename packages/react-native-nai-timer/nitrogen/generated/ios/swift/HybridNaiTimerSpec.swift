...
public extension HybridNaiTimerSpec_protocol {
...
open class HybridNaiTimerSpec_base {
  ...
  public func getCxxWrapper() -> HybridNaiTimerSpec_cxx {
  #if DEBUG
    guard self is any HybridNaiTimerSpec else {
    ...
    if let cxxWrapper = self.cxxWrapper {
      ...
      let cxxWrapper = HybridNaiTimerSpec_cxx(self as! any HybridNaiTimerSpec)
